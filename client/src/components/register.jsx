...
export const Register=()=>{
   ...
   const register=()=>{
     ...
     try{
         fetch(`http://localhost:2345/register`,{
         method:"POST",
...
return <>
        ...
        <div className="h-full  w-full py-6 px-4 text-gray-400">
            ...
            <div className="py-6"><img alt="imdb" src="https://m.media-amazon.com/images/G/01/imdb/authportal/images/www_imdb_logo._CB667618033_.png"/></div>
              ...
              <label>Name</label>
              <br/>
              <input className="focus-visible border-1" name="name"  onChange={handleChange}/>
              </div>

             <div className="text-left mt-2">
              <label>Email</label>
              <br/>
              <input className="focus-visible border-1" name="email"  onChange={handleChange}/>
              </div>

             <div className="text-left mt-2 mb-2">
              <label>Password</label>
              <br/>
              <input  className="focus-visible border-1" name="password"  onChange={handleChange}/>
              </div>
              <button className="bg-[#F2CD6F] px-5 py-2 w-40" onClick={register}>Create an account</button>
